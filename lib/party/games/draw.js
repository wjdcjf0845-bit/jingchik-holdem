...
const DRAWER_PER_CORRECT = 40;     // 드로어(그린 사람): 맞힌 사람 1명당 획득
...
module.exports = {
    ...
    rules: {
        ...
        scoring: [
            '맞힌 순서대로 <b>120 · 100 · 80…</b> (최소 40점)',
            '<b>그린 사람도</b> 맞힌 사람 1명당 40점 획득',
            '참가자 <b>전원이 한 번씩</b> 그립니다',
        ],
        tips: [
            '글자나 숫자를 쓰면 반칙!',
            '비슷한 말도 정답으로 인정되는 경우가 있어요 (우주비행사 = 우주인)',
            '한 라운드 75초',
        ],
    },
