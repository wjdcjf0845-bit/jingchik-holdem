...
module.exports = [
    ...
    { title: "It's Me", artist: '아일릿(ILLIT)', file: 'ILLIT (아일릿) - It’s Me (트로트 버전) [MV].mp3', start: 0,
      answers: ['잇츠미', '이츠미', 'its me'] },

    { title: 'LOVE ATTACK', artist: '리센느(RESCENE)', file: 'RESCENE (리센느) - LOVE ATTACK (트로트 버전) [MV].mp3', start: 0,
      answers: ['러브어택', '러브아탁', 'love attack'] },
];
